    ...
    <div className="p-4 md:p-6 space-y-5 max-w-4xl mx-auto">
      ...
      >
        ...
        <div className="relative">
          ...
          <p className="text-xs text-gray-500 mt-1"> {(user?.welcomeBonus ?? 0).toFixed(2)} USD</p>
      ...
      >
        ...
        <p className="text-3xl font-bold text-black dark:text-white">
           {(user?.welcomeBonus ?? 0).toFixed(2)} <span className="text-base font-semibold text-gray-400">USD</span>
        </p>
        ...
        <div className="mt-4 grid grid-cols-2 gap-4 pt-4 border-t border-gray-100 dark:border-white/10">
          <div>
            ...
            <p className="text-base font-bold text-black dark:text-white">
              {(user?.welcomeBonus ?? 0).toFixed(2)} USD
            </p>
          </div>
          <div>
            <p className="text-[11px] font-semibold tracking-widest text-gray-400 uppercase mb-1">
