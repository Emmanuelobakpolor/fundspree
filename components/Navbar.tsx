...
export default function Navbar() {
  ...
  <img
    ...
    alt="FundSphere"
    className="h-9 md:h-13 w-auto object-contain transition-transform duration-300 group-hover:scale-110 drop-shadow-lg dark:hidden"
  />
  {/* Dark mode: show the visually light logo so it's visible on dark bg */}
  <img
    src="/assets/fundsphere_dark_transparent.png"
    alt="FundSphere"
    className="h-9 md:h-13 w-auto object-contain transition-transform duration-300 group-hover:scale-110 drop-shadow-lg hidden dark:block"
  />
</Link>
